...
let isPressed = false;
const word_dict = {};
const libarr = ['affordable', 'water', 'gap', 'pollution', 'minority', 'infrastructure', 'renewable', 
'stronger', 'top', 'effective', 'gas', 'leadership', 'ecological', 'bankers', 'changing', 'greenhouse', 
'coalition', 'bottom', 'supports', 'leave', 'receive', 'revenues', 'company', 'weak', 'hold', 'educated', 
'amount', 'dominant', 'wealthiest', 'generate', 'solar', 'fewer', 'democracy', 'ability', 'rooted', 'homes', 
'forms', 'lobbyists', 'became', 'due', 'neighborhoods', 'equity', 'workingclass', 'extremely', 'primarily',
 'grants', 'violated', 'processes', 'death', 'insecurity', 'incomes', 'parts', 'ignoring', 'transportation',
  'relatively', 'protecting', 'improving', 'training', 'ordinary', 'inequalities', 'impact', 'toxic', 
  'cover', 'degradation', 'news', 'ideology', 'clinton', 'source', 'push', 'manufacturing', 'bills', 
  'inadequate', 'half', 'establishment', 'revenue', 'supposedly', 'seeking', 'generation', 'project', 
  'prison', 'breaks', 'practical', 'gross', 'gains', 'peace', 'positions', 'cheap', 'vehicles', 'planet',
   'taken', 'treatment', 'break', 'affluent', 'immigrants', 'focused', 'earnings', 'abstract', 'although', 
   'urban', 'broad', 'workplace', 'adequate', 'expanding', 'committee', 'extreme', 'bargaining', 
   'electricity', 'management', 'roads', 'farmers', 'per', 'sufficient', 'structural', 'purposes', 
   'capitalists', 'account', 'corporation', 'driven', 'seem', 'happy', 'hours', 'determined', 
   ...
   'species', 'domination', 'thinking', 'projects', 'affected', 'happiness', 'turned', 'third', 
   'executive', 'sold', 'realize', 'richest', 'head', 'hell', 'built', 'falling', 'dream', 'insurers',
    'expensive', 'space', 'rejected', 'achieving', 'struggle', 'proposal', 'later', 'standing', 
    'procedure', 'bring', 'compassion', 'agreements', 'classes', 'rest', 'vision', 'eight', 'counted', 
    ...
    'impossible', 'importance', 'overwhelming', 'rural', 'limit', 'dynamic', 'late', 'offered', 'calls',
     ...
     'took', 'strategies', 'claimed', 'voter', 'got', 'aggressively', 'humans', 'tremendous', 
     'accumulation', 'willing', 'initiatives', 'responses', 'treatments', 'includes', 'payroll', 
     'energysaving', 'banking', 'accounting', 'populist', 'backlash', 'retirees', 'reliance', 
     'exploitation', 'kinds', 'launch', 'compete', 'desperately', 'enact', 'shelters', 
     'environmentally', 'sustainable', 'thanks', 'represents', 'calling', 'grounds', 'attempts', 
      ...
      'loophole', 'block', 'turning', 'opposing', 'osub', 'link', 'meant', 'libertarians',
       ...
       'call', 'older', 'unfair', 'rungs', 'applied', 'express', 'faced', 'indeed', 'series',
        'relations', 'similar', 'FALSE', 'center', 'conscience', 'dying', 'implications', 'step', 
    ...
    'partnership', 'imperative', 'advantages', 'ca', 'loopholes', 'expenditures', 'package',
    ...
    'abused', 'decided', 'sharing', 'lifted', 'challenged', 'shown', 'places', 'shape', 'grand', 
    'content', 'mechanisms', 'elderly', 'disaster', 'naturally', 'excess', 'frequently', 'takes', 
    'cheats', 'crises', 'enjoyed', 'apply', 'shareholders', 'send', 'room', 'numerous', 'governing', 
...
'religion', 'economists', 'alarming', 'costly', 'saw', 'ineffective', 'teen', 'absolute', 'voting',
 ...
 'talent', 'environmentalism', 'intentions', 'schemes', 'lawsuit', 'began', 'desperate', 'beliefs',
  'whites', 'came', 'character', 'taught', 'premiums', 'decision', 'samesex', 'article', 'borrowers', 
  'reflect', 'attract', 'license', 'ipcc', 'mother', 'defending', 'male', 'arms', 'critics', 'guncontrol', 
