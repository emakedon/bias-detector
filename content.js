...
'terrorist', 'suffer', 'vote', 'unintended', 'founders', 'regardless', 'murder', 'confidence', 
...
'rule', 'opposition', 'thousands', 'required', 'pointed', 'theory', 'weapon', 'dismiss', 
...
'rely', 'felt', 'kennedy', 'trouble', 'unborn', 'powers', 'departments', 'determine', 
...
'virtues', 'changed', 'previously', 'hospitals', 'bailout', 'acting',
'youth', 'strongly', 'bankrupting', 'recently', 'entitlement', 'workforce', 'lesser', 'design', 'related',
 'boosting', 'addiction', 'concerns', 'neoliberal', 'opposite', 'remain', 'leverage', 
...
'term', 'negligible', 'regime', 'cash', 'restricting', 'litigation', 'concludes',
...
'ice', 'chapter', 'size', 'alcohol', 'goals', 'panic', 'freed', 'hurts', 'adopt', 
